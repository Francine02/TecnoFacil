...
export function Objectives() {
    return (
        <div className="text-center mt-5 pb-32 sm:pb-44 lg:pb-24 2xl:pb-28">
            <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-10 pt-5 justify-items-center ">
